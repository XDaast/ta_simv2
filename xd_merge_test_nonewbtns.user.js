...
(function() {
  ...
  v.innerHTML = "(" + function() {
    function v() {
      ...
      Arrows:{Down:"webfrontend/theme/arrows/down.png", Left:"webfrontend/theme/arrows/left.png", Right:"webfrontend/theme/arrows/right.png", Up:"webfrontend/theme/arrows/up.png"}, CNCOpt:"http://cncopt.com/favicon.ico", Defense:{Building:"FactionUI/icons/icon_arsnl_def_building.png", Infantry:"FactionUI/icons/icon_arsnl_def_squad.png", Vehicle:"FactionUI/icons/icon_arsnl_def_vehicle.png"}, DisableUnit:"FactionUI/icons/icon_disable_unit.png", Enemy:{All:"FactionUI/icons/icon_arsnl_show_all.png", 
      ...
      qx.Class.define("TABS.UTIL.Formation", {statics:{Get:function(a, b) {
        ...
        for (var d = 0;d < a.length;d++) {
          null !== c && a[d].y != c || "h" != b || (a[d].x = Math.abs(a[d].x - ClientLib.Base.Util.get_ArmyMaxSlotCountX() + 1)), null !== c && a[d].x != c || "v" != b || (a[d].y = Math.abs(a[d].y - ClientLib.Base.Util.get_ArmyMaxSlotCountY() + 1));
        }
        return a;
      }, Set:function(a, b, c) {
